...
export default function DetailedInfo(props: DetailedInfoProps): JSX.Element {
    ...
    <div className="overlay" onClick = {(e) => closePopUp(e)}>
      ...
      <div className="content">
        <div className="detailed-card">
          ...
          <button className="btn-clone btn dark">Clone to my CookBook</button>
          </div>

          <div className="author">{author}</div>

          <div className="container-description">
            <div className="image" style ={{ background: `url(../../../public/${image}) center no-repeat` }}></div>
            <div className="description">
              <div className="container-title">Description</div>
              <p>{description}</p>
            </div>
          ...
          <div className="container-recipes">
            <div className="container-title">Recipes</div>
          </div>
          <div className="container-comments">
          <div className="container-title">{`Comments (${comments.length})`}</div>
          </div>
        </div>
      </div>
    </div>
