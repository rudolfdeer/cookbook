    ...
    <div className="filter-panel cookbooks">
      ...
      <div className="filter-panel__section sort">
        <label className = "section__title" htmlFor="sort">Sort by</label>
          <select defaultValue = {sortOrder} className = "select" name="sort" id="sort" onChange = {(e) => sort(e)}>
      ...
      <div className="filter-panel__section type">
        ...
        <div className="section__checkboxes">
          <div className="checkbox">
            <input type="checkbox" className = "checkbox__input" id="vegetarian" name="vegetarian" value="Vegetarian" onClick = {(e) => filter(e)}/>
            <label htmlFor="vegetarian">Vegetarian</label>
          </div>
          <div className="checkbox">
            <input type="checkbox" className = "checkbox__input" id="nomilk" name="nomilk" value="Without milk" onClick = {(e) => filter(e)}/>
            <label htmlFor="nomilk">Without milk</label>
          </div>
          <div className="checkbox">
            <input type="checkbox" className = "checkbox__input" id="noeggs" name="noeggs" value="Without eggs" onClick = {(e) => filter(e)}/>
