...
export default function RecipeCard(props: RecipeCardProps): JSX.Element {
  ...
  return (
    <div className="recipes-page-card">
      ...
      <div className="container bottom">
        <div className="container-statistics">
          <div className="info views">
            <svg className = "icon" width="16" height="11" viewBox="0 0 16 11" fill="none" xmlns="http://www.w3.org/2000/svg">
          ...
          <div className="info likes">
            <svg className = "icon" width="17" height="15" viewBox="0 0 17 15" fill="none" xmlns="http://www.w3.org/2000/svg">
