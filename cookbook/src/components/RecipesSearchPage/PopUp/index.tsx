        ...
        <div className="pop-up">
          ...
          <div className="recipe-container">
            ...
            <div className="pop-up-sections">
              ...
              <div className="pop-up-section information">
                <div className="pop-up-section directions">
                  <div className="pop-up-section-title">Directions</div>
                ...
                <div className="pop-up-section ingredients">
                  <div className="pop-up-section-title">Ingredients</div>
