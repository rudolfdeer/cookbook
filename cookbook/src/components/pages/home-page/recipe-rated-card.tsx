...
import './recipe-rated-card.scss';

type RecipeRatedCardProps = {
  name: string;
  author: string;
  views: number;
  likes: number;
...
export default function RecipeRatedCard(props: RecipeRatedCardProps): JSX.Element {
  ...
  return (
    <div className="recipe-rated-card">
      ...
      <img className="recipe-rated-card-image" src={`../../../public/${image}`}/>

      <div  className="container middle">
        <div className="recipe-rated-card-title">{name}</div>
        <div className="recipe-rated-card-author">{author}</div>
      </div>
