          ...
          <div className="wrapper">
            ...
            <section className="personal-info">
              ...
              <form action="" className="personal-info__form">
                ...
                <input type="text" name = "name" value={username} className="form__input" disabled/>
                <input type="submit" className="form__input_submit" value="Edit"/>
              </form>
              <form action="" className="personal-info__form">
                <label htmlFor="email" className="form__label">Email</label>
                <input type="text" name = "email" value={email} className="form__input" disabled/>
                <input type="submit" className="form__input_submit" value="Edit"/>
              </form>
              <form action="" className="personal-info__form">
                <label htmlFor="password" className="form__label">Password</label>
                <input type="password" name = "password" value= {password} className="form__input" disabled/>
