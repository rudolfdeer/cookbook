...
export default function RecipeCard(props: RecipeCardProps): JSX.Element {
  ...
  return (
    <div className="card">
      ...
      <div className="card-info-container description">
        <p className="card-description">{description}</p>
      </div>
      <div className="card-info-container bottom">
        <div className="statistics">
          <div className="statistics-item views">
            <svg className = "statistics-item-icon" width="16" height="11" viewBox="0 0 16 11" fill="none" xmlns="http://www.w3.org/2000/svg">
        ...
        <svg className = "statistics-item dots" width="20" height="4" viewBox="0 0 20 4" fill="none" xmlns="http://www.w3.org/2000/svg">
